...
#luodaaan syötekentät,tekstikomponentit ja painikkeet. Painikkeissa image-komennolla liitetään niihin aiemmin tuodut png-kuvat.
#command komennolla yhdistetään painike ja funktio.
...
#pakataan komponentit, jolloin ne näkyvät ohjelmassa.
ohjnimi.pack()
kirjnimi.pack()
frame1.pack()
